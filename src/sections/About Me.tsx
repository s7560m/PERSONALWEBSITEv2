...
export default function AboutMe({setAboutMeVisible}: {setAboutMeVisible: Function}) {
    ...
    return <div id="about-me">
        ...
        <div style={{ position: "relative"}}>
            <MacDialog key={1} leftDesktop={10} topDesktop={10} leftMobile={10} topMobile={0} zIndex={1} title={"Some bio."} description={"Hello! I'm a 25-year old Computer Science Graduate from Western University. I like building full-stack websites like the one you see here. In my spare time, I make music, rock climb, do bodybuilding, and snowboard. "}/>
